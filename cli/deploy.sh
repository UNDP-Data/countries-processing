...
for prefix in 'admin0' 'admin1' 'admin2' 'hex-10km' 'hex-5km'  'hex-10km-ocean' 'grid-10km' 'grid-5km' 'grid-1km' 'grid-10km-ocean'; do
#for prefix in 'hex-10km'  'hex-10km-ocean' 'grid-10km' 'grid-10km-ocean'; do
#for prefix in 'hex-1km'; do
  echo 'publishing' $prefix
  export PREFIX=$prefix
  #eval $(cat ./.env | sed 's/^/export /')
  #envsubst < manifest.tpl.yml > manifest.yml

  az container delete --resource-group undpdpbppssdganalyticsgeo --name sids-data-pipeline-$PREFIX --yes
